...
async function getFollowingFeed(req) {
    ...
    const posts = await query(`SELECT DISTINCT p.*, a.handle as author_handle, a.display_name as author_display_name,
...
async function getTrendingFeed(req) {
    ...
    const posts = await query(`SELECT p.*, a.handle as author_handle, a.display_name as author_display_name,
            n.name as network_name,
